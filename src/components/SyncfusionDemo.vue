    ...
    <div>
      ...
      >
        <e-columns>
          ...
          <e-column field="email" headerText="E-mail" minWidth='100' width="120" textAlign="Center" type="boolean" />
          ...
          <e-column field="department" headerText="Department" minWidth='100' width="120" textAlign="Center"/>          <e-column field="telephone" headerText="Telephone" minWidth='100' width="120" textAlign="Center"/>
